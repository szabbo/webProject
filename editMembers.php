    ...
    <div class="container">
        <div id="registerUsers">
            ...
            <form action="includes/signup.inc.php" method="post">
                ...
                <input type="text" name="isAdmin" placeholder="Administrator da/ne...">
                <input type="text" name="userPhoneNumber" placeholder="Kontakt broj...">
                <input type="text" name="userAddress" placeholder="Adresa...">
                <button type="submit" name="signup-submit">Dodaj</button><br><br>
            </form>
        </div>     
    </div>
