...
<div class="page">
    ...
    <div class="container">
        ...
        <form action="" method="post" class="txtEditor">
            ...
            <button type="submit" name="ckeditor-submit">Pohrani promjene</button><br><br>
        </form>
            ...
            <table border = 1 cellpadding = 1 cellspacing = 1>
                ...
                <?php
                    ...
                    if (isset($_POST['ckeditor-submit'])) {
                        ...
                        // echo "Hello";
                        //updating data in db
                        $sql = "UPDATE notifications SET notificationContent='$editorContent' WHERE notificationId='$id'";
